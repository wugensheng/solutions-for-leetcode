...
- 找到返回下标
- 找不到只有两种情况：这两种情况下，最终插入的位置都是right + 1
  - left==right, num[mid] > target: right = mid - 1
  - left == right, num[mid] < target: left = mid + 1 
...
[题解](https://leetcode.cn/problems/move-zeroes/solution/kuai-man-shuang-zhi-zhen-by-hai-shang-li-svhw/)
...
[题解](https://leetcode.cn/problems/remove-linked-list-elements/solution/lian-biao-xu-ni-tou-zhi-zhen-by-hai-shan-u42q/)
...
[题解](https://leetcode.cn/problems/swap-nodes-in-pairs/solution/lian-biao-liang-liang-jiao-huan-by-hai-s-ceuc/)
